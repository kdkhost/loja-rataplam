...
class SettingRepository
{
    ...
    public function update($request)
    {
        ...
        $setting_fields = ['is_attribute_search', 'is_range_search', 'is_shop', 'is_blog', 'is_campaign', 'is_brands', 'is_faq', 'is_contact', 'is_loader', 'recaptcha', 'is_google_analytics', 'is_google_adsense', 'is_facebook_pixel', 'is_facebook_messenger', 'is_privacy_trams', 'is_guest_checkout', 'is_disqus', 'is_single_checkout', "is_show_category", 'is_pwa'];
