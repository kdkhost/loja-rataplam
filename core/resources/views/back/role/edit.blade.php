						...
						<div class="col-lg-10">
							<div class="p-5">
								...
								<div class="row">
									...
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="Correios Integration" {{in_array('Correios Integration',$section) ? 'checked' : ''}} id=""> Correios Brasil
									</div>
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="Promotional Popups" {{in_array('Promotional Popups',$section) ? 'checked' : ''}} id=""> Popups Promocionais
									</div>
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="WhatsApp Floating Buttons" {{in_array('WhatsApp Floating Buttons',$section) ? 'checked' : ''}} id=""> WhatsApp Flutuante
									</div>
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="Import Old Products" {{in_array('Import Old Products',$section) ? 'checked' : ''}} id=""> Importar Produtos Antigos
									</div>
