						...
						<div class="col-lg-10">
							<div class="p-5">
								...
								<div class="row">
									...
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="Correios Integration" id=""> Correios Brasil
									</div>
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="Promotional Popups" id=""> Popups Promocionais
									</div>
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="WhatsApp Floating Buttons" id=""> WhatsApp Flutuante
									</div>
									<div class="col-md-4 my-3">
										<input type="checkbox" name="section[]" value="Import Old Products" id=""> Importar Produtos Antigos
									</div>
