...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Notifications List') }}</h5>
        <ol class="breadcrumb">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
            ...
            <div class="d-block text-right">
                <a class="btn btn-primary btn-sm py-1 clear-notf" data-href="{{ route('back.notifications.clear') }}" href="javascript:;">
                    <small>{{ __('Clear All') }}</small>
                </a>
            </div>
            @forelse(App\Models\Notification::where('is_read', 0)->orderby('id','desc')->get() as $notf)
            @if($notf->user_id != null)
                <div class="d-flex align-items-center notification-list-item">
