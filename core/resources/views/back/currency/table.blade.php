...
<tr>
    ...
    <td>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="{{ route('back.currency.status',[$data->id,1]) }}">{{ __('Default') }}</a>
            </div>
          </div>
    ...
    <td>
        <div class="dropdown">
            <button class="btn btn-{{  $data->status == 1 ? 'success' : 'dark'  }} btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              {{  $data->status == 1 ? __('Active') : __('Deactive')  }}
            </button>
            <div class="dropdown-menu animated--fade-in">
                <a class="dropdown-item" href="{{ route('back.currency.status',[$data->id,1]) }}">{{ __('Active') }}</a>
