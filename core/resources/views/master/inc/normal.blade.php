<ul class="nav">
    ...
    @php
        ...
        $can = fn ($permission) => in_array($permission, $section);
        $canAny = fn (array $permissions) => count(array_intersect($permissions, $section)) > 0;
    @endphp

    @if ($canAny(['Manage Categories', 'Manage Products', 'Import Old Products']))
        <li class="nav-item">
    ...
    @if ($canAny(['Manage Orders', 'Transactions']))
    ...
    @if ($canAny(['Ecommerce', 'Correios Integration']))
        <li class="nav-item">
    ...
    @if ($canAny(['Customer List', 'Manages Tickets', 'WhatsApp Floating Buttons']))
        <li class="nav-item">
    ...
    @if ($canAny(['Manage Products', 'Promotional Popups', 'Subscribers List', 'Manage Site']))
        <li class="nav-item">
    ...
    @if ($canAny(['Manage Site', 'Manage Faqs Contents', 'Manage Blogs', 'Manages Pages']))
        <li class="nav-item">
    ...
    @if ($canAny(['Manage System User', 'System Backup']))
        <li class="nav-item">
