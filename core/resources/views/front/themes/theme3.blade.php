                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img src="{{ url('/core/public/storage/images/'.$service->photo) }}" alt="{{ __('Shipping image') }}">
                                <div class="content">
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        @endif
                                            <img class="lazy" data-src="{{url('/core/public/storage/images/'.$popular_category_item->thumbnail)}}" alt="{{ __('Product image') }}">
                                ...
                                <div class="slider-item">
                                    ...
                                    <div class="product-card p-col">
                                        <a class="product-thumb" href="{{route('front.product',$two_column_category_item->slug)}}">
                                            ...
                                            <img class="lazy" data-src="{{url('/core/public/storage/images/'.$two_column_category_item->thumbnail)}}" alt="{{ __('Product image') }}"></a>
                                        <div class="product-card-body">
