            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{isset($home_page4_banner['url1']) ? $home_page4_banner['url1'] : ''}}" class="h3-category {{ !empty($home_page4_banner['hide_text1']) ? 'banner-text-hidden' : '' }}">
                        ...
                        <a href="{{isset($home_page4_banner['url2']) ? $home_page4_banner['url2'] : ''}}" class="h3-category {{ !empty($home_page4_banner['hide_text2']) ? 'banner-text-hidden' : '' }}">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 middleImage">
                        <a href="{{isset($home_page4_banner['url3']) ? $home_page4_banner['url3'] : ''}}" class="h3-category {{ !empty($home_page4_banner['hide_text3']) ? 'banner-text-hidden' : '' }}">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{isset($home_page4_banner['url4']) ? $home_page4_banner['url4'] : ''}}" class="h3-category {{ !empty($home_page4_banner['hide_text4']) ? 'banner-text-hidden' : '' }}">
                        ...
                        <a href="{{isset($home_page4_banner['url5']) ? $home_page4_banner['url5'] : ''}}" class="h3-category {{ !empty($home_page4_banner['hide_text5']) ? 'banner-text-hidden' : '' }}">
                                ...
                                @if ($item->is_type == 'feature')
                                    <div class="slider-item">
                                        <div class="product-card ">
                                            ...
                                            @endif
                                            <img class="lazy" data-src="{{url('/core/public/storage/images/'.$item->thumbnail)}}" alt="{{ __('Product image') }}">
                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img class="lazy" data-src="{{ url('/core/public/storage/images/'.$service->photo) }}" alt="{{ __('Shipping image') }}">
                                <div class="content">
