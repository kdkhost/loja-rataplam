          ...
          <div class="col-lg-8">
            ...
            <div class="u-table-res wishlist-table mb-0">
              <table class="table table-bordered mb-0">
                ...
                <tr>
                    <td>
                      <div class="product-item"><a class="product-thumb" href="{{route('front.product',$product->slug)}}"><img src="{{url('/core/public/storage/images/'.$product->photo)}}" alt="{{ __('Product image') }}"></a>
                    ...
                    <td class="text-center"><a class="remove-from-cart" href="{{route('user.wishlist.delete',$product->getWishlistItemId())}}" data-toggle="tooltip" title="{{ __('Remove item') }}"><i class="icon-x"></i></a></td>
                  </tr>
                @endforeach
                @else
