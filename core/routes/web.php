...
Route::group(['middleware' => ['adminlocalize', 'demo']], function () {
    Route::prefix('admin')->group(function () { 
        ...
        Route::get('/notification/read/{id}', 'Back\NotificationController@read')->name('back.notification.read');
        ...
        Route::group(['middleware' => 'permissions:Ecommerce'], function () {
            ...
            Route::post('/setting/payment/mercadopago/{environment}/activate', 'Back\MercadoPagoSettingController@activate')->name('back.setting.payment.mercadopago.activate');
            Route::post('/setting/payment/mercadopago/{environment}/deactivate', 'Back\MercadoPagoSettingController@deactivate')->name('back.setting.payment.mercadopago.deactivate');
        });
        ...
        Route::group(['middleware' => 'permissions:Manage Site'], function () {
            ...
            Route::get('/pwa', 'Back\PlatformController@pwa')->name('back.platform.pwa');
            Route::post('/pwa/update', 'Back\PlatformController@updatePwa')->name('back.platform.pwa.update');
            Route::get('/internal-cron', 'Back\PlatformController@cron')->name('back.platform.cron');
            Route::post('/internal-cron/store', 'Back\PlatformController@storeCron')->name('back.platform.cron.store');
            Route::put('/internal-cron/{task}/update', 'Back\PlatformController@updateCron')->name('back.platform.cron.update');
            Route::get('/internal-cron/{task}/run', 'Back\PlatformController@runCron')->name('back.platform.cron.run');
            Route::delete('/internal-cron/{task}/delete', 'Back\PlatformController@destroyCron')->name('back.platform.cron.destroy');
            Route::get('/correios', 'Back\PlatformController@correios')->name('back.platform.correios');
            Route::post('/correios/update', 'Back\PlatformController@updateCorreios')->name('back.platform.correios.update');
            Route::post('/correios/test', 'Back\PlatformController@testCorreios')->name('back.platform.correios.test');
            Route::get('/popups', 'Back\PlatformController@popups')->name('back.platform.popups');
            Route::post('/popups/update', 'Back\PlatformController@updatePopups')->name('back.platform.popups.update');
            Route::get('/whatsapp-floating', 'Back\PlatformController@whatsapp')->name('back.platform.whatsapp');
            Route::post('/whatsapp-floating/update', 'Back\PlatformController@updateWhatsapp')->name('back.platform.whatsapp.update');
            Route::get('/old-products/import', 'Back\PlatformController@oldProducts')->name('back.platform.old-products');
            Route::post('/old-products/import', 'Back\PlatformController@importOldProducts')->name('back.platform.old-products.import');
...
Route::get('/manifest.webmanifest', 'Front\PwaController@manifest')->name('front.pwa.manifest');
Route::get('/sw.js', 'Front\PwaController@serviceWorker')->name('front.pwa.sw');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::post('/mercadopago/webhook', 'Payment\MercadopagoLegacyController@webhook')->name('front.mercadopago.webhook');
